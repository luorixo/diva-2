...
def main():
    ...
    for index, row in metadata_df.iterrows():
        ...
        rate = row['Rate']
        poison_accuracy = row['Test.Poison']
        ...
        try:
            ...
            second_difference = y_pred[0] - poison_accuracy
            print(f"Row {index}: P = {y_pred[0]}, A = {test_label}, Poison = {poison_accuracy}, Difference = {difference}, sDifference = {second_difference}")
